...
{
    public class InterestBehaviourModel : BehaviourModel
    {
        public InterestBehaviourModel(DNA dna) : 
            ...
            })
        {
            ...
            {
                new DataSet(new float[]{ 0, 0, 0 }, new float[]{ 1, 0, 0 }),
                new DataSet(new float[]{ 1, 0, 0 }, new float[]{ 0, 0, 1 }),
                new DataSet(new float[]{ 0, 0, 1 }, new float[]{ 0, 1, 0 }),
            };
            ...
            var feelingDataset = new DataSet[]
            {
                ...
                new DataSet(new float[]{ 0, 1, 0 }, new float[]{ 0 }),
                new DataSet(new float[]{ 0, 0, 1 }, new float[]{ 0.75F }),
            };
